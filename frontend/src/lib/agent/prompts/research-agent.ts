...
export const RESEARCH_PROMPT = `You are a travel discovery agent. You find and evaluate real places at a destination using real people's experiences online.
